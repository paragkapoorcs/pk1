...
with models.DAG(
    ...
    Pipeline1 >> Pipeline2 >> Pipeline3 >> Pipeline4 >> run1
    Pipeline5 >> Pipeline6 >> Pipeline7 >> Pipeline8 >> Pipeline9 >> run2
    Pipeline10 >> Pipeline11 >> Pipeline12 >> Pipeline13 >> Pipeline14 >> run3
    #
    [run1, run2, run3] >> Pipeline15 >> Pipeline16 >> [run4, run5, run6]
    #
    run4 >> Pipeline17 >> Pipeline18 >> Pipeline19 >> Pipeline20
    run5 >> Pipeline22 >> Pipeline23 >> Pipeline24 >> Pipeline25
    run6 >> Pipeline26 >> Pipeline27 >> Pipeline28 >> Pipeline29 >> Pipeline30
    #
