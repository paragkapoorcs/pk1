##Bigquery public weather data set. Each table is a different year. Will need to make this dynamic
##This will need to join back to private data
view: weather_raw {
  derived_table: {
...
###########################
## This is where we can add private data location id
view: distances {
  derived_table: {
    #datagroup_trigger: daily
